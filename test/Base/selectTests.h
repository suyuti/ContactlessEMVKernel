#ifndef _TEST_SELECT_H_
#define _TEST_SELECT_H_
...
TEST_F(Test_Select, _buildSelect) {
    ...
    int actual = _buildSelect(aid, 
                              sizeof(aid), 
                              buffer, 
                              &size);
    EXPECT_EQ(SUCCESS, actual);
    EXPECT_EQ(10, size);
    EXPECT_TRUE(memcmp(buffer, expectedBuffer, sizeof(expectedBuffer)) == 0);
}
...
TEST_F(Test_Select, _setFciIssData) 
{
    ...
    int actual = _setFciIssData(&fci, 
                                ...
                                sizeof(_4FData));
    EXPECT_EQ(SUCCESS, actual);
    EXPECT_TRUE(memcmp(fci._fciIssData[0]._4F, expected4FData, sizeof(expected4FData)) == 0);
    ...
    actual = _setFciIssData(&fci, 
                            ...
                            sizeof(_50Data));
    EXPECT_EQ(SUCCESS, actual);
    EXPECT_TRUE(memcmp(fci._fciIssData[0]._50, 
                       expected50Data, 
                       sizeof(expected50Data)) == 0);
    ...
    actual = _setFciIssData(&fci, 
                            ...
                            sizeof(_87Data));
    EXPECT_EQ(SUCCESS, actual);
    EXPECT_TRUE(memcmp(fci._fciIssData[0]._87, 
                       expected87Data, 
                       sizeof(expected87Data)) == 0);
    ...
    actual = _setFciIssData(&fci, 
                            ...
                            sizeof(_9F2AData));
    EXPECT_EQ(SUCCESS, actual);
    EXPECT_TRUE(memcmp(fci._fciIssData[0]._9F2A, 
                       expected9F2AData, 
                       sizeof(expected9F2AData)) == 0);
}
//-----------------------------------------------------------------------
...
TEST_F(Test_Select, OnTag_resolvePpse) 
{
    ...
    EXPECT_EQ(SUCCESS, actual);
    EXPECT_TRUE(memcmp(fci._84, expectedValue84, sizeof(expectedValue84)) == 0);
...
TEST_F(Test_Select, _resolveSelectPpse) 
{
    ...
    EXPECT_TRUE(memcmp(fci._fciIssData[0]._9F2A, expected9F2A, sizeof(expected9F2A)) == 0);

    unsigned char expected87[] = {0x01, 0x01};
    EXPECT_TRUE(memcmp(fci._fciIssData[0]._87, expected87, sizeof(expected87)) == 0);
}
