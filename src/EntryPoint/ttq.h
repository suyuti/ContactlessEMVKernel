...
#define SET_MAGSTRIPE_SUPP()                SET_BIT(ttq[MAGSTRIPE_SUPP_BYTE], MAGSTRIPE_SUPP_BIT)
#define SET_EMV_MODE_SUPP()                 SET_BIT(ttq[EMV_MODE_SUPP_BYTE], EMV_MODE_SUPP_BIT)
#define SET_EMV_CONTACT_CHIP_SUPP()
#define SET_OFFLINE_ONLY_READER()
#define SET_ONLINE_PIN_SUPP()
#define SET_SIGNATURE_SUPP()
#define SET_ODA_FOR_ONLINE_AUTH_SUPP()
#define SET_ONLINE_CRYPT_REQ()
#define SET_CVM_REQ()
#define SET_OFFLINE_PIN_SUPP()
#define SET_ISS_UPDATE_SUPP()
#define SET_CONS_DEV_CVM_SUPP()

#define RESET_MAGSTRIPE_SUPP()                SET_BIT(ttq[MAGSTRIPE_SUPP_BYTE], MAGSTRIPE_SUPP_BIT)
#define RESET_EMV_MODE_SUPP()                 SET_BIT(ttq[EMV_MODE_SUPP_BYTE], EMV_MODE_SUPP_BIT)
...
#define IS_MAGSTRIPE_SUPP()                SET_BIT(ttq[MAGSTRIPE_SUPP_BYTE], MAGSTRIPE_SUPP_BIT)
#define IS_EMV_MODE_SUPP()                 SET_BIT(ttq[EMV_MODE_SUPP_BYTE], EMV_MODE_SUPP_BIT)
